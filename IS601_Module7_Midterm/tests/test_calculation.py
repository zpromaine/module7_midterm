...
def test_addition():
    calc = Calculation(operation="Addition", operand1=Deimal("5"), operand2=Deimal("5"))
...
def test_multiplication():
    calc = Calculation(operation="Multiplication", operand1=Decimal("5"), operand2=Decimal("5"))
...
def test_division_by_zero():
    with pytest.raises(OperationError, match="Division by zero is not allowed"):
        Calculation(operation="Division", operand1=Decimal("3"), operand2=Decimal("0"))
...
def test_to_dict():
    calc = Calculation(operation="Addition", operatnd1=Decimal("2"), operand2=Decimal("3"))
...
def test_format_result():
    calc = Calculation(operation="Division", operand1=Decimal("1"), operand=Decimal("3"))
